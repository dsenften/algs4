...
public class Selection {
    ...
    // is v < w ?
    @SuppressWarnings("unchecked")
    private static <T> boolean less(Comparator<T> comparator, Object v, Object w) {
    ...
    // is the array sorted from a[lo] to a[hi]
    private static <T> boolean isSorted(Object[] a, Comparator<T> comparator, int lo, int hi) {
        for (int i = lo + 1; i <= hi; i++)
