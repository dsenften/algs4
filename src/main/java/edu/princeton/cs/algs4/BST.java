...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    private Value get(@NonNull Node x, Key key) {
        if (x == null) {
            return null;
        }
     ...
     * @throws NullPointerException   if {@code key} is {@code null}
     */
    public Key floor(@NonNull Key key) {
        if (isEmpty()) {
    ...
    /**
     * Internal recursive functen that returns the largest key in the symbol
     * table less than or equal to {@code key}.
     *
     * @param node starting node of the BST
     * @param key  the key to search for
     * @return the largest key in the symbol table less than or equal
     * to {@code key}; {@code null} if not found
     */
     ...
     * @throws NullPointerException   if {@code key} is {@code null}
     */
    public Key ceiling(@NonNull Key key) {
        if (isEmpty()) {
     ...
     *
     * @param node starting node in the BST
     * @param rank the order statistic
     * @return the key in the symbol table of given {@code rank}
     */
     ...
     * @throws NullPointerException if {@code key} is {@code null}
     */
    public int rank(@NonNull Key key) {
     ...
     *                              is {@code null}
     */
    public Iterable<Key> keys(@NonNull Key lo, @NonNull Key hi) {
     ...
     *                              is {@code null}
     */
    public int size(@NonNull Key lo, @NonNull Key hi) {
